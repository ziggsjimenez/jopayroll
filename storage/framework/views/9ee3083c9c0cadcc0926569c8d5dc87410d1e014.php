        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="md-form">
                    ...
                    <?php echo Form::select('office_id',$offices,null,['id'=>'office_id','name'=>'office_id','class' => 'form-control'.($errors->has('office_id') ? ' is-invalid' : ''),'placeholder'=>'Select...']); ?>
...
</div><?php /**PATH C:\xampp\htdocs\jopayroll\resources\views/appointments/modal/addemployee.blade.php ENDPATH**/ ?>
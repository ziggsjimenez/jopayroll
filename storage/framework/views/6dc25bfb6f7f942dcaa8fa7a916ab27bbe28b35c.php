...
<table style="padding-bottom: 5px">
    ...
    <tr>
        <td class="center office bolder"><?php echo e($payrollitem->employee->latestappemployee->last()->office->name); ?></td>
    </tr>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php $__currentLoopData = $payrollitem->refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <tr>
            <td class="item"><?php echo e($refund->refundtype->title); ?></td>
            <td class="right deductionitem"><?php echo e(number_format($refund->amount,2,'.',',')); ?></td>
    ...
    <tr>
        ...
        <td class="amounttotal"><?php echo e(number_format($payrollitem->totalrefunds(),2,'.',',')); ?></td>
    </tr>
...
<?php /**PATH C:\xampp\htdocs\jopayroll\resources\views/tables/payslips_edited.blade.php ENDPATH**/ ?>
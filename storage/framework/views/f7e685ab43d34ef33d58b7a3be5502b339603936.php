...
<head>
    ...
    <title>OBR - <?php echo e($payroll->description); ?></title>
...
<table>
        <tr><td style="width:20%">Payee: </td> <td class="payee"><?php echo e($payroll->chargeability->name); ?></td> </tr>
...
<table style="margin-top: 30px">
    ...
    <tr>
        ...
        <td class="withborder center particulars" style="width:40%"> Wages for the period of <?php echo e($payroll->datefrom->format('F d')); ?> - <?php echo e($payroll->dateto->format('F d, Y')); ?></td>
        <td class="withborder center" style="width:10%"></td>
        <td class="withborder center" style="width:20%"></td>
        <td class="withborder center" style="width:20%"><?php echo e(number_format($payroll->totalamount(),2,'.',',')); ?></td>
    </tr>
...
<table class="withborder">
    ...
    <tr>
        ...
        <td class="center bolder signature"><?php echo e($payroll->chargeability->headofoffice); ?></td>
        <td class="label">Printed Name: </td>
        <td class="center bolder signature">GRAHAM F. DELCO</td>
    </tr>
    <tr>
        <td class="label">Position: </td>
        <td class="center bolder signature"><?php echo e($payroll->chargeability->position); ?></td>
        <td class="label">Position: </td>
...
<?php /**PATH C:\xampp\htdocs\jopayroll\resources\views/payrolls/printobr.blade.php ENDPATH**/ ?>
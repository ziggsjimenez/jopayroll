...
<head>
    ...
    <title>Payslip - <?php echo e($payrollitem->employee->fullname()); ?></title>
...
<a class="btn btn-primary" href="<?php echo e(route('pdf.payslip',$payrollitem->id)); ?>">PDF</a>
<a class="btn btn-primary" href="<?php echo e(route('payrolls.show',$payrollitem->payroll_id)); ?>">BACK</a>
</body>
</html>
...
<?php /**PATH C:\xampp\htdocs\jopayroll\resources\views/payrollitems/show.blade.php ENDPATH**/ ?>